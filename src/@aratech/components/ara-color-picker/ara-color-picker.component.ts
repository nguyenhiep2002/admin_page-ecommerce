...
import { MatColors } from '@aratech/mat-colors';
...
export class AraColorPickerComponent implements ControlValueAccessor
{
    colors: any;
    hues: string[];
    view: string;
    ...
    set selectedBg(value)
    {
        ...
        this.updateSelectedColor(false);
    }
     ...
     */
    updateSelectedColor(close: boolean): void
    {
        ...
        if (close) {
            ...
            this.selectedBg = this.selectedColor.bg;
    ...
    onMenuOpen(): void
    {
        this.oldValue = this.selectedColor;
        this.changed = false;
    ...
    updateOldValue() {
        if (!this.changed) {
            this.selectedColor = this.oldValue;
