...
import { locale as navigationVietnameses } from 'app/navigation/i18n/vi';
...
export class LayoutComponent implements OnInit, OnDestroy
{
    ...
    {
        // Add languages
        this._translateService.addLangs(['en', 'vi', 'jp']);

        // Set the default language
        this._translateService.setDefaultLang('vi');

        // Set the navigation translations
        this._fuseTranslationLoaderService.loadTranslations(navigationEnglish, navigationVietnameses, navigationJapanese);
