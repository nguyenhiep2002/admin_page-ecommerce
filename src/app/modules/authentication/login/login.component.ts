...
export class FuseLoginComponent implements OnInit {
    ...
    alert: any = {}
    optionLogin: any = this.grant_type.Password
    ...
    // viettelLogin() {
    //     let ssoUrl = Configs.getConfig('ViettelSSOUrl')
    //     let ssoService = Configs.getConfig('ViettelSSOService')
    //     let ssoAppCode = Configs.getConfig('ViettelSSOAppCode')
    //     let url = `${ssoUrl}?service=${encodeURIComponent(ssoService)}&appCode=${encodeURI(ssoAppCode)}`
